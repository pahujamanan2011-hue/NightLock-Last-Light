...
| `1` | Switch to Pistol |
| `2` | Switch to Shotgun |
| `Scroll Wheel` | Toggle weapon |
| `P` or `Escape` | Pause / Unpause |
| `M` | Return to Main Menu (from pause or game over) |
| `Enter` | Retry (from game over) |

---

## ⚔️ Weapons

| Weapon | Fire Rate | Damage | Ammo Use | Notes |
|---|---|---|---|---|
| Pistol | Fast | 15 | 1 | Accurate, rapid fire |
| Shotgun | Slow | 22×5 | 2 | Spread shot, screen shake |
